                ...
                <form class="form-horizontal" action="">
                    ...
                    <div class="form-group left">
                       <div class="col-sm-10">
                         <label for="" class="control-label col-sm-3">Nombre</label>
                          <input type="text" class="form-control" name="name" id="name" v-model="mate.name">
                       </div>
                    </div>
                  <div class="form-group left row">
                      <div class="col">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control" name="year" id="year" v-model="mate.year">
                            </div>
                        </div>
                        <div class="col">
                          <label for="" class="control-label col-sm-5">ISBN</label>
                          <div class="col-sm-7">
                             <input disabled type="text" class="form-control" name="isbn" id="isbn" v-model="mate.isbn">
                          </div>
                        </div> 
                    </div>
                    <div class="form-group left row">
                      <div class="col">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control" name="num_pages" id="num_pages" v-model="mate.num_pages">
                            </div>
                        </div>
   ...
   <div class="form-group left row">
        <div class="col">
          ...
          <div class="col-sm-7">
            ...
            <option v-for="editorial_id in  editorial_id" v-bind:value="editorial_id.id"> {{ editorial_id.name }}
             </option>
            </select>
          </div>
        </div>
        <div class="col">
          ...
          <div class="col-sm-7">
           <select class="form-control" v-model="mate.area_id">
            <option v-for="area_id in area_id" v-bind:value="area_id.id"> {{ area_id.name }}
             </option>
            </select>
          </div>
        </div>
        ...
        <div class="col">
          ...
          <div class="col-sm-7">
            <select class="form-control" v-model="mate.type_material_id">
            <option v-for="type_material_id in type_material_id" v-bind:value="type_material_id.id"> {{ type_material_id.name }}
             </option>
            </select>
          </div>
        </div>
...
<br>
        <button type="button" v-on:click="actualizar()" class="btn btn-warning">Actualizar</button>
